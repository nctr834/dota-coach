  ...
  return (
    <div className="relative rounded-xl border border-white/10 bg-white/[0.02] overflow-hidden flex flex-col" style={{ height: '420px' }}>
      ...
      <div className="px-4 py-3 border-b border-white/5 flex items-center gap-2">
        ...
        <span className="text-sm font-semibold uppercase tracking-wider text-indigo-400">Coach</span>
        <span className="text-xs text-gray-600 ml-auto">AI-powered draft advice</span>
      </div>
